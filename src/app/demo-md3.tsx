...
export default function MaterialDesign3Demo() {
  ...
  // Tertiary colors from our color definitions
      ...
      <Card sx={{ mb: 4, borderRadius: 4 }}>
        <CardContent>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Stack direction="row" spacing={2} flexWrap="wrap" useFlexGap>
              <ColorSwatch color={tertiaryColors.main} name="Tertiary" />
              <ColorSwatch color={tertiaryColors.light} name="Tertiary Light" />
              <ColorSwatch color={tertiaryColors.dark} name="Tertiary Dark" />
              <ColorSwatch color={tertiaryColors.contrastText} name="On Tertiary" />
            </Stack>
          </Box>
